...
import { createContext, ThemeProvider, useTheme } from '@chakra-ui/react';
...
const baseBackgroundColor =
  ...
  (colorMode === 'dark'
    ? lighten(theme.colors.gray['900'], 0.05)
    : theme.colors.gray['900']);
return {
  baseBackgroundColor,
  draggingBorderColor: theme.colors.blue['500'],
  matchHighlightColor:
    colorMode === 'dark'
      ? darken(theme.colors.yellow['800'], 0.25)
      : lighten(theme.colors.yellow['300'], 0.5),
  menuBackgroundColor: lighten(baseBackgroundColor, 0.07),
  pinnedRowBackgroundColor: alpha(theme.colors.blue['500'], 0.1),
  selectedRowBackgroundColor: alpha(theme.colors.blue['500'], 0.2),
};
```
