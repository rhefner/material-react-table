...
> Note: In some frameworks like Remix, you may need to use a full import path like <br /> `import { MRT_Localization_ES } from 'chakra-react-table/locales/es/index.js';` or <br /> `import { MRT_Localization_ES } from 'chakra-react-table/locales/es/index.esm.js';` <br />
